    ...
    <footer className="bg-yellow">
      <section>
        <div className="container padding-top-50px padding-bottom-20px">
          <div className="row">
            <div className="col-12 d-flex flex-column flex-md-row align-items-start padding-top-20px padding-top-md-none padding-bottom-25px">
              <Link
                className="primary-link text-20px margin-bottom-25px margin-bottom-md-none"
                to="/"
              >
                Shop
              </Link>
          ...
          <div className="row">
            <div className="col-md-6 text-20px">
